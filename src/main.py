...
async def lifespan(app: FastAPI):
    ...
    trace_scoring_pool = TraceScoringPool()
    trace_scoring_pool.start()
    try:
        yield
    finally:
        ...
        try:
            ...
            pass
        # Stops claiming and waits for in-flight rows to settle -- a row's
        # lease is the ultimate backstop if the process is killed outright.
        await trace_scoring_pool.shutdown()
